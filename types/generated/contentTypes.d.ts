...
export interface ApiTienAnTienAn extends Schema.CollectionType {
  collectionName: 'tien_ans';
  info: {
    singularName: 'tien-an';
    pluralName: 'tien-ans';
    displayName: 'TienAn';
    description: '';
  };
  ...
  attributes: {
    ngaymua: Attribute.Date;
    sotien: Attribute.Integer;
    mota: Attribute.String;
...
declare module '@strapi/strapi' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::tien-an.tien-an': ApiTienAnTienAn;
